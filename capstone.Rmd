...
```
Binning the creation times of these accounts doesn't uncover anything that interesting. Although, the 6 month period with the highest number, "2015-09-01", was in the months following DJT declaring himslef a candidate for the GOP nomination. But there is nothing of note to suggest the two are related.
